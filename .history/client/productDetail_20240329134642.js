...
async function getProductById(productId) {
  try {
    ...
    const product = response.data; // Trích xuất thông tin sản phẩm từ response.data
    renderProductDetail(product); // Gọi hàm renderProductDetail với thông tin sản phẩm
  } catch (error) {
    console.log(error);
