...
formEdit.addEventListener("submit", async function (e) {
  ...
  // Khởi tạo biến để lưu trữ hình ảnh cũ
  let updatedImageData;

  // Kiểm tra xem có tệp hình ảnh mới được chọn không
  if (imageUpdate) {
    // Nếu có, sử dụng hình ảnh mới
    updatedImageData = imageUpdate;
  } else {
    // Nếu không, sử dụng hình ảnh cũ từ currentUser
    updatedImageData = currentUser.image;
  }
