...
async function handleEdit(id) {
  ...
  document.getElementById("previousImage").value = currentUser.image; // Lưu đường dẫn hình ảnh trước đó vào trường input hidden
...
document.getElementById("imageUpdate").addEventListener("change", function (e) {
  ...
  const previousImage = document.getElementById("previousImage").value; // Lấy đường dẫn hình ảnh trước đó
  if (previousImage) {
    // Nếu có hình ảnh trước đó, gán đường dẫn đó vào trường input file imageUpdate
    imageInput.files = [new File([], previousImage)];
  }
});
