...
async function handleEdit(id) {
  ...
  const imageUpdate = document.querySelector("#imageUpdate"); // Sửa từ getElementById thành querySelector
  if (currentUser.image) {
    imageUpdate.src = `http://localhost:3000/images/${currentUser.image}`; // Gán hình ảnh ban đầu cho thuộc tính src
  } else {
  ...
  if (Array.isArray(currentCategory)) {
    ...
    console.log("Dữ liệu danh mục không hợp lệ");
  }
