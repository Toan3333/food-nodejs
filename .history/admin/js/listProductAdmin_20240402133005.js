...
async function handleEdit(id) {
  ...
  // Hiển thị hình ảnh của sản phẩm trong form chỉnh sửa
  ...
  const file = new File([blob], currentUser.image); // Tạo đối tượng File từ blob
  document.getElementById("imageUpdate").files = [file]; // Gán đối tượng File vào trường nhập file
