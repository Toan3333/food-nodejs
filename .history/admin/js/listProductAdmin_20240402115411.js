...
function showcategory(item) {
  const template = `<option value="65f50bb9d3ae70c03ccc4530">${item.name}</option>
  <option value="65f9011c28564c0f6b279700">${item.name}</option>`;
  categoryUpdate.insertAdjacentHTML("beforeend", template);
}
...
async function handleEdit(id) {
  try {
    ...
    currentCategory.forEach((item) => {
      const template = `<option value="65f50bb9d3ae70c03ccc4530">${item._name}</option>
      <option value="65f9011c28564c0f6b279700">${item.name}</option>`;
    });
