...
})({"jRDYg":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "a12d8e2db3a50424";
"use strict";
...
},{}],"eXY6y":[function(require,module,exports) {
...
const deleteCate = async (id)=>{
    try {
        const response = await (0, _axiosDefault.default).delete(`http://localhost:3000/categories/${id}`);
        const data = response.data.Category;
        return data;
    } catch (error) {
        console.log("L\u1ED7i kh\xf4ng x\xf3a \u0111\u01B0\u1EE3c d\u1EEF li\u1EC7u", error);
    }
};
...
const getCateById = async (id)=>{
    try {
        const response = await (0, _axiosDefault.default).get(`http://localhost:3000/categories/${id}`);
...
async function handleEdit(id) {
    ...
    // id ẩn của cate để lưu
    document.getElementById("categoryId").value = id;
    showEditForm(); // Hiển thị form chỉnh sửa
}
const createCategory = async (NewCategory)=>{
    try {
        const response = await (0, _axiosDefault.default).post("http://localhost:3000/categories", NewCategory);
...
const updateCate = async (id, newUpdateCate)=>{
    try {
        const response = await (0, _axiosDefault.default).put(`http://localhost:3000/categories/${id}`, newUpdateCate);
        return response.data;
    } catch (error) {
...
formCategoryEdit.addEventListener("submit", async function(e) {
    ...
    try {
        const updatedCate = await updateCate(id, {
            name: nameUpdate
        }); // Truyền tên danh mục mới và ID vào hàm cập nhật
...
function renderCategory(item) {
    ...
    } else console.log("Kh\xf4ng c\xf3 d\u1EEF li\u1EC7u ho\u1EB7c thu\u1ED9c t\xednh '_id' kh\xf4ng t\u1ED3n t\u1EA1i.");
}
getDataCategory();

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jRDYg","eXY6y"], "eXY6y", "parcelRequiree8ef")

//# sourceMappingURL=categories.b3a50424.js.map
