...
})({"5sxBt":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "ddbf01641aad481e";
"use strict";
...
},{}],"eLCpf":[function(require,module,exports) {
...
async function getRedatedProductData(id) {
    try {
        const response = await (0, _axiosDefault.default).get(`http://localhost:3000/products/related/${id}`);
        const dataProductRelated = response.data.RelatedProducts;
        console.log(dataProductRelated);
        dataProductRelated.forEach((item)=>{
            showRelatedProduct(item);
        });
    } catch (error) {
        console.log("Kh\xf4ng l\u1EA5y \u0111\u01B0\u1EE3c s\u1EA3n ph\u1EA9m li\xean quan", error);
    }
}
getRedatedProductData(productId);
function showRelatedProduct(item) {
    const tempale = `<div class="special-item">
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5sxBt","eLCpf"], "eLCpf", "parcelRequiree8ef")

//# sourceMappingURL=product-detail.1aad481e.js.map
