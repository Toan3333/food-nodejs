...
})({"15KTt":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "a721d18703765b89";
"use strict";
...
},{}],"cB3St":[function(require,module,exports) {
...
async function getLoginData(email, pass) {
    try {
        const response = await (0, _axiosDefault.default).post("http://localhost:3000/users/login", {
            email,
            pass
        });
        return response.data;
    } catch (error) {
        console.error("\u0110\xe3 x\u1EA3y ra l\u1ED7i khi \u0111\u0103ng nh\u1EADp:", error);
        throw error;
    }
}
formLogin.addEventListener("submit", async function(e) {
    ...
    if (!email || !password) {
        alert("Vui l\xf2ng nh\u1EADp \u0111\u1EA7y \u0111\u1EE7 email v\xe0 m\u1EADt kh\u1EA9u.");
        return;
    }
    try {
        ...
        alert("Email ho\u1EB7c m\u1EADt kh\u1EA9u kh\xf4ng ch\xednh x\xe1c. Vui l\xf2ng ki\u1EC3m tra l\u1EA1i.");
        else {
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"iHFPX"}]},["15KTt","cB3St"], "cB3St", "parcelRequiree8ef")

//# sourceMappingURL=login.03765b89.js.map
