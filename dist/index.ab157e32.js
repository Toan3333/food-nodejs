...
})({"7jUuF":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "29b3e54bab157e32";
"use strict";
...
const getAll = async ()=>{
    try {
        const response = await (0, _axiosDefault.default).get("http://localhost:3000/products/special");
...
const getProductHot = async ()=>{
    try {
        ...
        const response = await (0, _axiosDefault.default).get("http://localhost:3000/products/hot", {
            headers: {
...
},{"axios":"jo6P5","buffer":"fCgem","@parcel/transformer-js/src/esmodule-helpers.js":"iHFPX"}]},["7jUuF","8h7jx"], "8h7jx", "parcelRequiree8ef")

//# sourceMappingURL=index.ab157e32.js.map
